...
[CreateAssetMenu(menuName = "MonsterFSM/FSM/Decider/AttackRangeDecider")]
public class AttackRangeDecider : MonsterDecider
{
    public override bool Condition(MonsterStateController msc)
    {
        ...
        return Vector3.Distance(playerPos, monsterPos) < msc.MInfo.AttackRange;
    }
}
